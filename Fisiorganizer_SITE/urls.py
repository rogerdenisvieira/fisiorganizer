...
# route for customers
customer_patterns = [
    re_path(r'^edit/(?P<id>\d{1,})', customer_controller.edit, name='customer_edit'),
...
session_patterns = [
    ...
    re_path(r'^(?P<id>\d{1,})/exercise/delete', session_controller.delete_exercise, name="delete_session_exercise")
]

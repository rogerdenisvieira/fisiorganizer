...
# route for customers
customer_patterns = [
    url(r'^edit/(?P<id>\d{1,})', customer_controller.edit, name='customer_edit'),
    url(r'^delete', customer_controller.delete, name='customer_delete'),
    url(r'^create', customer_controller.create, name='customer_create'),
    url(r'^details/(?P<id>\d{1,})', customer_controller.details, name='customer_details'),
    url(r'^list', customer_controller.list, name='customer_list')
]

# routes for sessions
session_patterns = [
    url(r'^edit/(?P<id>\d{1,})', session_controller.edit, name='session_edit'),

...
from Fisiorganizer_SITE.views.place_view import PlaceCreateView, PlaceEditView, PlaceListView, PlaceDetailView, PlaceDeleteView
from Fisiorganizer_SITE.views.evolution_view import EvolutionCreateView, EvolutionDeleteView, EvolutionDetailView, EvolutionListView, EvolutionUpdateView
...
evolution_patterns = [
    ...
    path(r'edit/<pk>', EvolutionUpdateView.as_view(), name='evolution_edit'),
    path(r'delete/<pk>', EvolutionDeleteView.as_view(), name='evolution_delete')
]
...
place_patterns = [
    ...
    path('edit/<pk>', PlaceEditView.as_view(), name='place_edit')
]
